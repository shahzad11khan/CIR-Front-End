...
const Updateproject = () => {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_API_KEY}/api/project/specificuploadedfile/`+id)
          .then((response) => {
    ...
    const Adduser = async (e) => {
        e.preventDefault();
        console.log(imageupload)
        const values={title,shortdescription,longdescription,imageupload,metatitle,metashortdescription,metalongdescription,metaimageupload}
        ...
        formData.append('file2', metaimageupload );
        formData.append('metalongdescription', metalongdescription);

     
        try {
        await axios.put(`${process.env.REACT_APP_API_KEY}/api/project/updateproject/`+id,formData)
                            ...
                            <div className="container-fluid">
                                ...
                                <div className='k' style={{ width: '70%', marginLeft: '10%' }}>
                                    ...
                                    <form id="Add-project-from">
                                        ...
                                        <img src={`${process.env.REACT_APP_API_KEY}/projects/images/${imageupload}`} style={{ width: '70px', height: '70px' }} alt={imageupload} />
                                        </div>
                                        <div class="from-item">
                                            <label htmlFor="projectImage">Image Upload </label><span style={{marginTop:'40px'}}></span>
                                            <input type="file"  className="form-control form-control-file" id="projectImage"
                                                name="file1" src={imageupload}  onChange={e => setImageUpload(e.target.files[0])}  />
                                        </div>
                                        {/* {imageupload} */}
                                        {/* <div class="from-item">
                                        ...
                                        <div class="from-item">
                                            <button type="submit" className="btn btn-primary form-control" onClick={Adduser}> Update Project</button>
                                        </div>
