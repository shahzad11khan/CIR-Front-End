...
const Updatepartners = () => {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_API_KEY}/api/partners/get/partners/` + id)
            .then((response) => {
    ...
    const Updateuser = async (e) => {
        ...
        e.preventDefault();
        try {
            await axios.put(`${process.env.REACT_APP_API_KEY}/api/partners/put/partners/` + id, formData)
                                ...
                                <div className='k' style={{ width: '60%', marginLeft: '20%', marginTop: '5%' }}>
                                    ...
                                    <form>
                                        <div className='from-item' style={{ display: 'flex', justifyContent: 'center' }}>
                                            <img src={`${process.env.REACT_APP_API_KEY}/partners/images/` + imagee} style={{ width: '70px', height: '70px' }} />
                                        </div>
                                        <div class="from-item">
                                            <label htmlFor="projectImage" style={{ display: 'flex' }} >Image</label>
                                        ...
                                        <br />
                                        <input type="button" class="btn btn-primary" value='Update Partner' onClick={Updateuser} />
                                    </form>
                                    <br />
                                </div>
