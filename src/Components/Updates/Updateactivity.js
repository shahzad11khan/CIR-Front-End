...
const Updateactivity = () => {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_API_KEY}/api/activites/specificuploadedfile/` + id)
            .then((response) => {
    ...
    const Adduser = async (e) => {
        ...
        try {
            await axios.put(`${process.env.REACT_APP_API_KEY}/api/activites/updateactivity/` + id, formData)
                    ...
                    <div id="content-wrapper" className="d-flex flex-column">
                            ...
                            <div className="container-fluid">
                                ...
                                <div className='k' style={{ width: '70%', marginLeft: '10%' }}>
                                    ...
                                    <form id="Add-project-from">
                                        ...
                                        <img src={`${process.env.REACT_APP_API_KEY}/activities/images/` + imageupload} style={{ width: '70px', height: '70px' }} alt={imageupload} />
                                        </div>
                                        <div class="from-item">
                                        ...
                                        <div class="from-item">
                                            <button type="submit" className="btn btn-primary form-control" onClick={Adduser}> Update Activity</button>
                                        </div>
                        ...
                        <footer className="sticky-footer bg-white">
                            <div className="container my-auto">
                                <div className="copyright text-center my-auto">                                    <span>Powered by Arure Technologies</span>
