...
// 
  ...
  const Deletehandler = async (id) => {
    try {
      await axios.delete(`${process.env.REACT_APP_API_KEY}/api/nature/natures/`+id)
      console.log("nature deleted");
                  ...
                  <table class="table">
                    <thead>
                      ...
                      <tr>
                        ...
                        {/* <th scope="col">Nature Description</th> */}
                        {
                      ...
                      <tr >
                        ...
                        {/* <td>{user.description}</td> */}
                        {
                          type && type == 'user' ? ('') : (
                            ...
                            <td>
                            <Link to={`/Updates/Updatenature/${user._id}`} className='btn btn-primary'>Edit Record</Link>
